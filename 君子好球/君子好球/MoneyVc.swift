...
class MoneyVc: UIViewController ,UIPickerViewDataSource, UIPickerViewDelegate{
    var myblock : blockBtnClickSendValue?
    let pickerview = UIPickerView()
    var numLeft:Int = 0
    var money :String = ""
    var moneyType:Array<String> = []
    ...
    func deterMineButtonClick() {
        if myblock != nil
        {
            myblock!(String(format:"%d %s",self.numLeft ,self.money))
        }
